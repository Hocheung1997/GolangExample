...
func TestUserService(t *testing.T) {
	...
	resp, err := usersClient.GetUser(context.Background(), &users.UserGetRequest{Email: "jane@doe.com", Id: "foo-bar"})
	...
	if resp.User.FirstName != "jane" {
		t.Errorf("Expect FirstName to be: jane, Got: %s", resp.User.FirstName)
	}
}
