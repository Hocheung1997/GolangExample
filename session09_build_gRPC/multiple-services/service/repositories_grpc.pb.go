...
const (
	Repo_GetRepo_FullMethodName = "/Repo/GetRepo"
)
...
type RepoClient interface {
	GetRepo(ctx context.Context, in *RepoGetRequest, opts ...grpc.CallOption) (*RepoGetReply, error)
}
...
func (c *repoClient) GetRepo(ctx context.Context, in *RepoGetRequest, opts ...grpc.CallOption) (*RepoGetReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RepoGetReply)
	err := c.cc.Invoke(ctx, Repo_GetRepo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RepoServer interface {
	GetRepo(context.Context, *RepoGetRequest) (*RepoGetReply, error)
...
func (UnimplementedRepoServer) GetRepo(context.Context, *RepoGetRequest) (*RepoGetReply, error) {
...
func _Repo_GetRepo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepoServer).GetRepo(ctx, req.(*RepoGetRequest))
	}
